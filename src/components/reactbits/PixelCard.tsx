...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`group relative overflow-hidden grid place-items-center isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className || 'h-[400px] w-[300px] aspect-[4/5] border border-[var(--pixel-card-border,#27272a)] bg-[var(--pixel-card-background,transparent)] rounded-[25px]'}`}
    ...
    >
      ...
      <canvas className="pointer-events-none absolute inset-0 z-20 w-full h-full block" ref={canvasRef} />
      {children}
    </div>
  );
}
